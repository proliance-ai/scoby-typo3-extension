...
interface AddressInterface
{
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\AssignedRange[] ranges are sorted
     *
     * @since 1.5.0
     */
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\AddressInterface|null return NULL if $n is not an integer or if the final address would be invalid
     *
     * @since 1.15.0
     *
