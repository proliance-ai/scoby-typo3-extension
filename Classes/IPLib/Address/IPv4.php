...
namespace Dse\Scoby\IPLib\Address;

use Dse\Scoby\IPLib\ParseStringFlag;
use Dse\Scoby\IPLib\Range\RangeInterface;
use Dse\Scoby\IPLib\Range\Subnet;
use Dse\Scoby\IPLib\Range\Type as RangeType;
...
class IPv4 implements AddressInterface
{
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::__toString()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getNumberOfBits()
     */
     ...
     * @return static|null
     *
     * @see \Dse\Scoby\IPLib\Address\IPv4::parseString()
    ...
    public static function parseString($address, $flags = 0)
    {
        ...
        $math = new \Dse\Scoby\IPLib\Service\UnsignedIntegerMath();
        $nums = array();
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::toString()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getBytes()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getBits()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getAddressType()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getDefaultReservedRangeType()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getReservedRanges()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getRangeType()
     */
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\IPv6
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getComparableString()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::matches()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getAddressAtOffset()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getNextAddress()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getPreviousAddress()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Address\AddressInterface::getReverseDNSLookupName()
     */
