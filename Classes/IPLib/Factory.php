...
namespace Dse\Scoby\IPLib;

use Dse\Scoby\IPLib\Address\AddressInterface;
use Dse\Scoby\IPLib\Range\Subnet;
use Dse\Scoby\IPLib\Service\RangesFromBoundaryCalculator;
...
class Factory
{
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\AddressInterface|null
     *
     * @see \Dse\Scoby\IPLib\Factory::parseAddressString()
     ...
     * @return \Dse\Scoby\IPLib\Address\AddressInterface|null
     *
     * @see \Dse\Scoby\IPLib\ParseStringFlag
     * @since 1.17.0
     */
     ...
     * @param bool $supportNonDecimalIPv4
     *
     * @return \Dse\Scoby\IPLib\Range\RangeInterface|null
     *
     * @see \Dse\Scoby\IPLib\Factory::parseRangeString()
     * @since 1.10.0 added the $supportNonDecimalIPv4 argument
     */
     ...
     * - if $supportNonDecimalIPv4 is true, use the ParseStringFlag::IPV4_MAYBE_NON_DECIMAL flag
     *
     * @param string|\Dse\Scoby\IPLib\Address\AddressInterface|mixed $from
     * @param string|\Dse\Scoby\IPLib\Address\AddressInterface|mixed $to
     * @param bool $supportNonDecimalIPv4
     *
     * @return \Dse\Scoby\IPLib\Address\AddressInterface|null
     *
     * @see \Dse\Scoby\IPLib\Factory::getRangeFromBoundaries()
     * @since 1.2.0
     * @since 1.10.0 added the $supportNonDecimalIPv4 argument
     */
     ...
     * @param int $flags A combination or zero or more flags
     *
     * @return \Dse\Scoby\IPLib\Range\RangeInterface|null return NULL if $from and/or $to are invalid addresses, or if both are NULL or empty strings, or if they are addresses of different types
     *
     * @see \Dse\Scoby\IPLib\ParseStringFlag
     * @since 1.17.0
     */
     ...
     * @param bool $supportNonDecimalIPv4
     *
     * @return \Dse\Scoby\IPLib\Range\Subnet[]|null
     *
     * @see \Dse\Scoby\IPLib\Factory::getRangesFromBoundaries()
     * @since 1.14.0
     */
     ...
     *
     * @param string|\Dse\Scoby\IPLib\Address\AddressInterface $from
     * @param string|\Dse\Scoby\IPLib\Address\AddressInterface $to
     * @param int $flags A combination or zero or more flags
     *
     * @return \Dse\Scoby\IPLib\Range\Subnet[]|null return NULL if $from and/or $to are invalid addresses, or if both are NULL or empty strings, or if they are addresses of different types
     *
     * @see \Dse\Scoby\IPLib\ParseStringFlag
     * @since 1.17.0
     */
    ...
    /**
     * @param \Dse\Scoby\IPLib\Address\AddressInterface $from
     * @param \Dse\Scoby\IPLib\Address\AddressInterface $to
     *
     * @return \Dse\Scoby\IPLib\Range\RangeInterface|null
     *
     * @since 1.2.0
     ...
     * @param int $flags
     *
     * @return \Dse\Scoby\IPLib\Address\AddressInterface[]|null[]|false[]
     */
