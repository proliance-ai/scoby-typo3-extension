...
namespace Dse\Scoby\IPLib\Range;

use Dse\Scoby\IPLib\Address\AddressInterface;
use Dse\Scoby\IPLib\Address\IPv4;
use Dse\Scoby\IPLib\Address\IPv6;
use Dse\Scoby\IPLib\Address\Type as AddressType;
...
class Pattern extends AbstractRange
{
     ...
     *
     * @var \Dse\Scoby\IPLib\Address\AddressInterface
     */
     ...
     *
     * @param \Dse\Scoby\IPLib\Address\AddressInterface $fromAddress
     * @param \Dse\Scoby\IPLib\Address\AddressInterface $toAddress
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::__toString()
     */
     ...
     * @return static|null
     *
     * @see \Dse\Scoby\IPLib\Range\Pattern::parseString()
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::toString()
     */
    public function toString($long = false)
    {
        ...
        switch (true) {
            case $this->fromAddress instanceof \Dse\Scoby\IPLib\Address\IPv4:
                $chunks = explode('.', $this->fromAddress->toString());
                $chunks = array_slice($chunks, 0, -$this->asterisksCount);
                $chunks = array_pad($chunks, 4, '*');
                $result = implode('.', $chunks);
                break;
            case $this->fromAddress instanceof \Dse\Scoby\IPLib\Address\IPv6:
                if ($long) {
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getAddressType()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getStartAddress()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getEndAddress()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getComparableStartString()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getComparableEndString()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::asSubnet()
     * @since 1.8.0
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::asPattern()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getSubnetMask()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getReverseDNSLookupName()
     */
     ...
     * {@inheritdoc}
     *
     * @see \Dse\Scoby\IPLib\Range\RangeInterface::getSize()
     */
