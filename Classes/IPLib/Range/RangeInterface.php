...
interface RangeInterface
{
     ...
     *
     * @return int One of the \Dse\Scoby\IPLib\Address\Type::T_... constants
     */
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\AddressInterface|null return NULL if $n is not an integer or if the offset out of range
     *
     * @since 1.15.0
     *
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\AddressInterface
     *
     * @since 1.4.0
     */
     ...
     *
     * @return \Dse\Scoby\IPLib\Address\IPv4|null return NULL if the range is an IPv6 range, the subnet mask otherwise
     *
     * @since 1.8.0
     */
     ...
     *
     * @return \Dse\Scoby\IPLib\Range\Subnet
     *
     * @since 1.13.0
     */
     ...
     *
     * @return \Dse\Scoby\IPLib\Range\Pattern|null return NULL if this range can't be represented by a pattern notation
     *
     * @since 1.13.0
     */
