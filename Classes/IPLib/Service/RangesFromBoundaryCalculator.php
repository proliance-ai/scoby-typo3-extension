...
namespace Dse\Scoby\IPLib\Service;
...
class RangesFromBoundaryCalculator
{
     ...
     *
     * @var \Dse\Scoby\IPLib\Service\BinaryMath
     */
    private $math;
     ...
     *
     * @return \Dse\Scoby\IPLib\Range\Subnet[]|null return NULL if the two addresses have an invalid number of bits (that is, different from the one passed to the constructor of this class)
     */
     ...
     * @param \Dse\Scoby\IPLib\Range\Subnet[] $result found ranges will be added to this variable
     */
